...
class LSTMProcess(Processor):
    ...
    def build_model(self, hp):
        ...
        model.add(Bidirectional(LSTM(units=64, return_sequences=True, input_shape=(self.X_train.shape[1], self.X_train.shape[2]))))
    ...
    def train(self) -> "LSTMProcess":
        ...
        tuner = BayesianOptimization(
            ...
            project_name=self.config.batch_code + '_lstm_tuning_v5'
        )
        ...
        for train_index, test_index in tscv.split(self.X):
            ...
            tuner.search(X_train, y_train, epochs=100, validation_data=(X_test, y_test), callbacks=[early_stopping, reduce_lr], verbose=1)
