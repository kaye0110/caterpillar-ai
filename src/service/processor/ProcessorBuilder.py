...
class ProcessorBuilder:
    ...
    @staticmethod
    def build_by_batch_code(batch_code: str, stock_code: str = "all", model_idx: str = "") -> "Processor":
        datastore = DataStore(batch_code)
        config_json = datastore.load_model(datastore.get_config_name(batch_code, stock_code, model_idx), file_type="json")
